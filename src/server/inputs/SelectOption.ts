...
import {InputResponse, isSelectOptionResponse, SelectOptionResponse} from '../../common/inputs/InputResponse';
...
export class SelectOption extends BasePlayerInput<undefined> {
  ...
  public agent(_algo: AgentAlgo, _p: IPlayer): SelectOptionResponse {
    return { type: 'option' };
  }
}
